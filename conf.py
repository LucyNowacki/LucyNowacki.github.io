...
BLOG_AUTHOR = "Lucy Nowacki"  # (translatable)
BLOG_TITLE = "Nova Automata"  # (translatable)
...
BLOG_EMAIL = "quantlucy@gmail.com"
...
<form method="get" action="https://www.qwant.com/" class="navbar-form navbar-right" role="search">
  <style>
    ...
    <div class="input-group">
        <input type="text" name="q" class="form-control" placeholder=" Qwant Search">
...
EXTRA_HEAD_DATA = '''
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-YWLRJ2M88S"></script>
<script>
  ...
  <meta name="google-site-verification" content="WF1l7hEMV49eJl7Kb2rVSOwXp2KINwX59Tig6ACvfSs" />
'''
